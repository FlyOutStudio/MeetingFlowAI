...
7. Mermaidタブの「draw.ioで図を開く」を選ぶと、編集可能な業務フロー図がdraw.io Web版で直接生成されます。CopyまたはExportではMermaidソースも利用できます。
